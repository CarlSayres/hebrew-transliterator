...
- Lexicon: `https://hebrewtransliterator.com/speech/barukh-sheamar-v1.xml`
- Test SSML: `https://hebrewtransliterator.com/speech/barukh-sheamar-lexicon-test.ssml`
...
3. Paste the contents of `barukh-sheamar-lexicon-test.ssml`.
