...
## Google Analytics virtual pages

For visitors who accept optional Analytics cookies, successful Sefaria imports
and audio actions are also sent to Google Analytics as virtual page views. This
