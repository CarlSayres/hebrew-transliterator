...
const styleCases = [
  [
    ...
    [
      ...
      ["הַלְלוּהוּ", "Hal'luhu"],
      ["הַ֥לְלוּ", "Hal'lu"],
      ["הַלְל֥וּהוּ", "Hal'luhu"],
      ["הַלְלִי", "Hal'li"],
      ["הַרְרֵי", "Har'rei"],
      ["הַמְמַלְּטִים", "Ha-m'mal'tim"],
      ["וּמֹשֶׁה", "U-mosheh"],
      ...
      ["מִֽי־כָמֹ֤כָה בָּֽאֵלִם֙ יְהֹוָ֔ה        מִ֥י כָּמֹ֖כָה נֶאְדָּ֣ר בַּקֹּ֑דֶשׁ", "Mi khamokhah ba-eilim Adonai        mi kamokhah nedar ba-kodesh"],
      ["בְּעָלְמָא", "B'alma"],
      ...
      ,
      ["וּנְשַׁבֵּחֲךָ", "U-n'shabeiḥakha"],
      ["וּבְכָל", "U-v'khol"],
      ...
      ["וְיִתְהַדַּר", "V'yit·hadar"],
      ["וְיִתְהַלַּל", "V'yit·halal"],
      ["בִּטְחוּ", "Bit·ḥu"],
      ["אֶשְׁתַּחֲוֶה", "Esh·taḥaveh"],
      ["אֲבַקֵּשְׁךָ", "Avakeish'kha"],
      ["יְבָרֶכְךָ", "Y'varekh·kha"],
      ["הַ֥לְלוּ־יָ֨הּ הַֽלְלוּ־אֵ֥ל בְּקׇדְשׁ֑וֹ הַֽ֝לְל֗וּהוּ בִּרְקִ֥יעַ עֻזּֽוֹ׃", "Hal'luyah hal'lu El b'kodsho hal'luhu birkia uzo:"],
      ["הַלְל֥וּהוּ בִגְבוּרֹתָ֑יו הַ֝לְל֗וּהוּ כְּרֹ֣ב גֻּדְלֽוֹ׃", "Hal'luhu vi-g'vurotav hal'luhu k'rov gudlo:"],
      ["הַ֭לְלוּהוּ בְּתֵ֣קַע שׁוֹפָ֑ר הַ֝לְל֗וּהוּ בְּנֵ֣בֶל וְכִנּֽוֹר׃", "Hal'luhu b'teika shofar hal'luhu b'neivel v'khinor:"],
      ["הַ֭לְלוּהוּ בְּתֹ֣ף וּמָח֑וֹל הַֽ֝לְל֗וּהוּ בְּמִנִּ֥ים וְעֻגָֽב׃", "Hal'luhu b'tof u-maḥol hal'luhu b'minim v'ugav:"],
      ["הַלְל֥וּהוּ בְצִלְצְלֵי־שָׁ֑מַע הַֽ֝לְל֗וּהוּ בְּֽצִלְצְלֵ֥י תְרוּעָֽה׃", "Hal'luhu v'tziltz'lei shama hal'luhu b'tziltz'lei t'ru·ah:"],
      ["כֹּ֣ל הַ֭נְּשָׁמָה תְּהַלֵּ֥ל יָ֗הּ הַֽלְלוּ־יָֽהּ׃", "Kol ha-n'shamah t'hallel yah hal'luyah:"]
    ]
  ],
  [
    "mishkanTefilah",
...
const stressMarkCases = [
  ...
  ["וַיֹּ֩אמֶר֩", "Vayómer"],
  ["מִצְרַ֒יִם֒", "Mitzráyim"],
  ["הַמֶּ֒לֶךְ֒", "Hamélekh"],
  ["הָאֹ֙הֱלָה֙", "Ha·óhelah"],
...
const pronunciationHebrewCases = [
  ["חָכְמָה", "חוֹכְמָ", "e"],
  ["שְׁמַע", "שֶׁמַע", "e"],
  ["גָּאָֽלְתָּ", "גָאָֽלְתָ", "e"],
  ["וּבְמֹפְתִֽים", "וּבְמוֹפֶתִֽים", "e"],
  ["כְּכָל", "כֶּכוֹל", "e"],
  ["שֶׁכָּל", "שֶׁכּוֹל", "e"],
  ["מִצְרָיְמָה", "מִצְרָיְמָ", "e"],
  ["מִלְחָמוֹת", "מִלְחָמֹת", "e"],
  ["בֵּן", "בֶּין", "ei"],
  ["שֶׁלֺּא", "שֶׁלּוֹ", "e"],
  ["שֶׁהֵם", "שֶׁהֶים", "ei"],
  ["בְּתוֹרָתוֹ", "בֶּתֹרָתֹ", "e"],
  ["הַקָּדוֹשׁ", "הַקָדֹשׁ", "e"],
  ["וַהֲשֵׁבֹתָ", "בַהֲשֵׁבוֹתָ", "e"],
  ["מָצָא", "מָצָ", "e"],
  ["תּוֹרָה", "תֹרָ", "e"],
  ["אַתָּה", "אַתָ", "e"],
  ["בָּהּ", "בָּהּ", "e"],
  ["גּוֹזֵר", "גֹזֵר", "e"],
  ["לָנֶֽצַח", "לָנֶֽצַך", "e"],
  ["בִּשְׁבָחוֹת", "בִּשְׁ בָחֹת", "e"],
  ["וְאָהַבְתָּ", "בֶאָהַבְתָ", "e"],
  ["וָבֶטַח", "בָבֶטַך", "e"],
  ["וֹ", "בוֹ", "e"],
  ["לִירֵאָיו", "לִירֵהאָב", "e"],
  ["לִירֵאָיו", "לִירֵיאָב", "ei"],
  ["דָּבָ֔ר", "דָּבָ֔ר", "e"],
  ["מֶֽלֶךְ", "מֶֽלֶךְ", "e"],
  ["בְּכָל֯", "בֶּכוֹל", "e"],
  ["בֶכָל", "בֶכוֹל", "e"],
  ["שֶׁבְּכָל", "שֶׁבֶּכוֹל", "e"],
  ["הֵיכָל", "הֵיכָל", "e"],
  ["וַיַּ֧רְא", "בַיַּ֧ר", "e"],
  ["מָצָא {פ} מָצָא {ס}", "מָצָ מָצָ", "e"],
  ["יְהֹוָ֔ה מֶֽלֶךְ׃", "אֲדֹנָי מֶֽלֶךְ:", "e"]
];
